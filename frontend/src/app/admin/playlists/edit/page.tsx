...
export default function PlaylistEditPage() {
  ...
  return (
    <div className="max-w-3xl flex flex-col gap-4">
      ...
      <div>
        <label htmlFor="playlist-module-slugs" className="text-xs uppercase tracking-widest font-semibold mb-1 block" style={{ color: 'var(--ffv-muted)' }}>
          Module slugs (1 por linha, ordem importa)
        </label>
        <textarea id="playlist-module-slugs" value={moduleSlugsText} onChange={e => setModuleSlugsText(e.target.value)} rows={12} spellCheck={false}
