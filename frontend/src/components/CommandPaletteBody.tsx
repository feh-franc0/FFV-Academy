...
import { SearchIcon } from './palette-ui';
...
/**
 * Corpo do palette: TUDO o que depende do currículo mora aqui.
 *
 * Este arquivo é carregado sob demanda (ver `CommandPalette.tsx`), e a
 * razão é medida: ele importa `CURRICULUM`, e o currículo completo pesa
 * 224 KB no bundle. Como o palette vive no layout raiz, esse peso estava
 * no primeiro carregamento das 95 rotas — inclusive `/verificar` e
 * `/sobre`, que não têm busca nenhuma.
 */
export function CommandPaletteBody({ open, setOpen }: {
  open: boolean;
