  ...
  const data = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description:
          'Trilha completa de Genética Veterinária: das Leis de Mendel ao melhoramento animal. 12 módulos sequenciais com teoria, exercícios, simulado de 100 questões e revisão espaçada.',
