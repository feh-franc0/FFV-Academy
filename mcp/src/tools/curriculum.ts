...
import type { ArticleListItem, FFVClient } from "../client.js";
import type { Config } from "../config.js";
import { safe, buildDiff } from "../util.js";

// ─── Taxonomia estática ───────────────────────────────────────────────────────
// Sincronizada com frontend/src/lib/curriculum.ts — atualizar quando o currículo mudar.

export const HUBS_STATIC = [
  {
    id: "hub-ia",
    slug: "ia",
...
export function registerCurriculumTools(server: McpServer, client: FFVClient, _cfg: Config): void {
  server.registerTool(
    "list_hubs",
    {
      title: "Listar hubs",
