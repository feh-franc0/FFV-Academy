	...
	bases := []BaseDTO{
		{
			Slug:        "tecnologia",
			Name:        "Tecnologia",
			AreaLabel:   "IA · AWS · Engenharia · Programação · Hardware · OS · Compiladores · Mercado Tech",
		...
		},
		{
			...
			AreaLabel:   "Cérebro · Poder · Influência · Riqueza · Cialdini · Kahneman · Greene",
			Description: "Por que humanos compram, desejam, cedem ao poder, seguem líderes e acumulam ou perdem riqueza — com evidência. Cialdini (7 gatilhos), Neuroeconomia (Kahneman/Ariely/Thaler/Damasio), Como o Cérebro Funciona (Eagleman/Ramachandran/MacLean/Rizzolatti), As 48 Leis do Poder (Robert Greene), Influência & Liderança de Comunidades (Carnegie + Godin + Sinek + ética anti-seita via modelo BITE de Hassan) e Psicologia da Riqueza (Hill + Stanley + Housel + Bourdieu + Dweck).",
			Status:      "live",
			Icon:        "🧲",
