...
func buildHardcodedBases(counts map[string]int) []BaseDTO {
	bases := []BaseDTO{
		...
		},
		{
			Slug:        "ingles",
			Name:        "Inglês",
			AreaLabel:   "Gramática · 10 cenários · 80 fluxos + Sobrevivência Turista",
			Description: "Inglês para brasileiros pra gringa com 9 trilhas e 99 módulos. Cada fluxo traz um trecho de DIÁLOGO REAL (4-6 turnos naturais) + 100 trocas: Cotidiano (aeroporto/moradia/médico/banco), Vida Prática (mecânico/contratante/vet/mudança), Negócios (standup/pitch/FAANG/salário), Corporativo Avançado (VC pitch/boardroom/demissão/burnout), Academia (office hours/conference/tese/orientador), Social (Tinder/conflito/luto), Relacionamento Profundo (Thanksgiving/pedido casamento/USCIS/sogro difícil), Emergências (911/ER/polícia/ICE/IRS/saúde mental) e Sobrevivência Turista (imigração agressiva/perdido sem internet/mercado local/restaurante estrangeiro/hotel pequeno/Uber+metrô/shopping trocar/farmácia/perdi passaporte/SOCORRO quando não entendi).",
			Status:      "live",
			Icon:        "🌎",
			URL:         "/ingles",
			Modules:     99,
		...
		},
		{
			Slug:        "cinema",
			Name:        "Cinematografia",
			AreaLabel:   "Linguagem · Roteiro · DP · Direção · Edição · Som · Produção · VLOG · DaVinci Resolve 20",
