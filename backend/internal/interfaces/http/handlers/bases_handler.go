...
func buildHardcodedBases(counts map[string]int) []BaseDTO {
	bases := []BaseDTO{
		...
		},
		{
			...
			AreaLabel:   "Portfólio · Vagas · Interview · Promoção",
		...
		},
		{
			Slug:        "comunicacao",
			Name:        "Comunicação",
			AreaLabel:   "Falar em público · Technical Writing · RFCs",
		...
		},
		{
			...
			AreaLabel:   "SEO · Branding · CAC/LTV · Funil",
		...
		},
		{
			...
			AreaLabel:   "YouTube · LinkedIn · Gravação · Monetização",
		...
		},
		{
			...
			AreaLabel:   "Solo SaaS · Indie Hacker · MVP · Freelance",
		...
		},
		{
			Slug:        "ingles",
			Name:        "Inglês",
			AreaLabel:   "Gramática · 10 cenários reais · Trabalho na gringa",
